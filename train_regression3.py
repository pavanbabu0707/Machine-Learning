...
iris = load_iris()
X = iris.data[:, [0, 1]] 
y = iris.data[:, 2] # Petal length for output
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.title('Model 3 Training Loss - No Regularization')
plt.savefig('Model 3 loss_no_regularization.png')
plt.show()
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.title('Model 3 Training Loss - With Regularization')
plt.savefig('Model 3 loss_with_regularization.png')
plt.show()
