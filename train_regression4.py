...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.title('Model 4 Training Loss - No Regularization')
plt.savefig('Model 4 loss_no_regularization.png')
plt.show()
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.title('Model 4 Training Loss - With Regularization')
plt.savefig('Model 4 loss_with_regularization.png')
plt.show()
